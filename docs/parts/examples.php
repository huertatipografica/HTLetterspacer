  <section id="examples" data-magellan-target="examples">
      ...
      <div class="medium-8 medium-offset-3 columns">
        <p>This is a screen recording applying the script in two different fonts/families:</p>
      ...
      <div class="medium-8 medium-offset-3 columns" style="clear:both;float:none">

        <p>Screencast explaining how to use it:</p>
        <div class="flex-video">
